...
class Stadium14 extends BaseStadium implements StadiumInterface
{
    ...
    public function times(int $raceNumber, ?string $date = null): array
    {
        ...
        foreach (range(1, 6) as $bracket) {
            ...
            $response['bracket_' . $bracket . '_exhibition_time'] = (float) ($times['.col5'][$bracket * 2] ?? 0);
    ...
    public function comments(int $raceNumber, ?string $date = null): array
    {
        ...
        foreach (range(1, 6) as $bracket) {
            ...
            $response['bracket_' . $bracket . '_racer_comment_1'] = $this->formatComment($comments['.col10'][$bracket]);
        }
